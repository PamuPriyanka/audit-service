...
public final class AuditSpecification {
    ...
    public static Specification<AuditEntity> actorIdEquals(
            String actorId) {
        return (root, query, cb) ->
                cb.equal(root.get("actorId"), actorId);
    }

    public static Specification<AuditEntity> resourceTypeEquals(
            String resourceType) {
        return (root, query, cb) ->
                cb.equal(root.get("resourceType"), resourceType);
    }

    public static Specification<AuditEntity> resourceIdEquals(
            Long resourceId) {
        return (root, query, cb) ->
                cb.equal(root.get("resourceId"), resourceId);
    }

    public static Specification<AuditEntity> eventTypeEquals(
            String eventType) {
        return (root, query, cb) ->
                cb.equal(root.get("eventType"), eventType);
    }

    public static Specification<AuditEntity> from(
            LocalDateTime from) {
        return (root, query, cb) ->
    ...
    public static Specification<AuditEntity> to(
            LocalDateTime to) {
        return (root, query, cb) ->
